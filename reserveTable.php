<?php
    ...
    if (isset($_POST['reserve-btn'])){
        ...
        if (empty($guests) || empty($date) || empty($time)){
            header("location: home.php?error=emptyfields==".$_SESSION['email']);
            exit();
        }
                    ...
                    if (!mysqli_stmt_prepare($stmt, $sql)){
                        ...
                        header("location: home.php?reservation=success=".$_SESSION['rmail']);
                        exit();
                    }
                } 
    ...
    elseif (isset($_POST['cancel_reservation'])) {
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)){
            ...
            header("location: home.php?reservation+canceled=".$_SESSION['rmail']);
            exit();
        }
    }
    else{
